...
\protect\hyperlink{ref-Gonzalez2016}{Gonzalez et al., 2016};
...
implemented a simple model for gradual dehydration and eclogitization of
oceanic crust. Dehydration of oceanic crust is computed as a linear
function of depth (lithostatic pressure), with a maximum depth (150
\(km\)), or temperature (1427 \(^\circ C\)), where the slab became
...
2011}). Eclogitization was modelled by the garnet-in and plagioclase-out
reactions defined by \protect\hyperlink{ref-Ito1971}{Ito \& Kennedy}
(\protect\hyperlink{ref-Ito1971}{1971}).
...
wedge at shallow levels (\protect\hyperlink{ref-Agard2016}{Agard et al.,
2016}; \protect\hyperlink{ref-Hyndman2003}{Hyndman \& Peacock, 2003};
...
We implicitly assumed slabs of different ages release water similarly.
...
1996}). Stronger slab-age-dependent differences in mechanical coupling
...
(\protect\hyperlink{ref-Schmidt1998}{Schmidt \& Poli, 1998}), which was
...
defined by local dynamic (non-lithostatic) pressure gradients (after
\protect\hyperlink{ref-Faccenda2009}{Faccenda et al., 2009}). The fluid
velocities are scaled by a 10 \(cm/yr\) vertical percolation velocity to
account for purely lithostatic pressure gradients in the mantle (after
\protect\hyperlink{ref-Gorczyk2007}{Gorczyk et al., 2007}, see Appendix,
(De-)hydration model). The fluid particle migrates until it reaches
...
erosion proposed for subarc lithosphere. The following mechanisms of
...
Gonzalez, C. M., Gorczyk, W., \& Gerya, T. (2016). Decarbonation of
subducting slabs: Insight from petrological--thermomechanical modeling.
\emph{Gondwana Research}, \emph{36}, 314--332.
...
Ito, K., \& Kennedy, G. C. (1971). An experimental study of the
basalt-garnet granulite-eclogite transition. \emph{The Structure and
Physical Properties of the Earth's Crust}, \emph{14}, 303--314.
