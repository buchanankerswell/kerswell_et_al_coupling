...
\protect\hyperlink{ref-Grove2012}{Grove et al., 2012};
...
Number & Rock Type\\
\midrule
17 & Quenched Basalt from Gabbro\\
18 & Quenched Basalt from Mantle\\
19 & Dry Lower-Density Mantle\\
23 & Molten Sediments\\
24 & Molten Sediments\\
\addlinespace
25 & Molten Felsic Crust\\
26 & Molten Felsic Crust\\
27 & Molten Basalt\\
28 & Molten Basalt\\
29 & Molten Dry Mantle\\
\addlinespace
30 & Molten Dry Mantle\\
31 & Molten Dry Mantle\\
34 & Molten Hydrated Mantle\\
35 & Molten Quenched Sediments\\
36 & Molten Basalt from Basalt\\
\addlinespace
37 & Molten Basalt from Gabbro\\
38 & Molten Basalt from Mantle\\
\bottomrule
\end{tabular}
\end{table}
...
implemented a simple model for gradual dehydration (eclogitization) of
oceanic crust, computed as a linear function of depth (lithostatic
pressure), with a maximum depth (150 \(km\)) where the slab was
completely dehydrated. This approach effectively simulates a continuous
...
2011}). We implicitly assume slabs of different ages release water
...
thermal gradients (\protect\hyperlink{ref-Peacock1996}{Peacock, 1996}).
...
wedge at shallow levels (\protect\hyperlink{ref-Hyndman2003}{Hyndman \&
Peacock, 2003}; \protect\hyperlink{ref-Peacock1999a}{Peacock \& Hyndman,
1999}). If so, noting that brucite breaks down at much lower
temperatures than serpentine
(\protect\hyperlink{ref-Schmidt1998}{Schmidt \& Poli, 1998}), the loss
of serpentine likely represents the key transition from a weak wedge
(and subduction interface) to a strong wedge. Dehydration of serpentine
was modelled as an abrupt, discontinuous reaction, which is a good
approximation for near-endmember compositions, like (Mg-rich)
...
gradient in the mantle (see Appendix,
\protect\hyperlink{ref-Faccenda2009}{Faccenda et al., 2009}). The fluid
...
conditions and can contain up to 13 \(wt.\%\) water
...
erosion proposed for subarc lithosphere {[}e.g.,
\protect\hyperlink{ref-Arcay2006}{Arcay et al.}
(\protect\hyperlink{ref-Arcay2006}{2006}); England2010;
\protect\hyperlink{ref-Sobolev2005}{Sobolev \& Babeyko}
(\protect\hyperlink{ref-Sobolev2005}{2005}){]}. The following mechanisms
of lithospheric erosion have been proposed: lithospheric delamination
...
\hypertarget{de-hydration-model}{%
\subsection{(De-)hydration model}\label{de-hydration-model}}
