...
%DIF DEL ../g3_v1/g3_v1.tex         Wed Feb 17 03:23:17 2021
%DIF ADD ../g3_v2/coupling_v2.tex   Wed Feb 17 17:21:02 2021
...
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=\textwidth, trim={0 0 0 0}]{figs/Fig1.png}
...
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=\textwidth, trim={0 0 0 0}]{figs/Fig2.png}
...
%DIFDELCMD <  \includegraphics[width=\textwidth, trim={0 0 0 0}]{figs/Fig3.png}
...
where \DIFdelbegin \DIFdel{$z$ and $\Phi$ are in $km$.Equation}\DIFdelend \DIFaddbegin \DIFadd{\(z\) is in \(km\) and \(\Phi\) is in \(km/100\). Regression
...
vs.}\DIFaddend ~\DIFdelbegin \DIFdel{\ref{Equation6} }\DIFdelend \DIFaddbegin \DIFadd{\(z_{1100}\) and \(\Phi\) fit the experiments well.
Equation~\ref{eq:zc} }\DIFaddend permits the prediction of the mechanical coupling
depths in modern subduction zones where \DIFdelbegin \DIFdel{backarc lithospheric thickness (inverted from
backarc heat flow ) and slab thermal parameter can be estimated.
A web-based application to perform such calculations is available for free online (see Appendix A)
}\DIFdelend \DIFaddbegin \DIFadd{\(z_{c}\) can be inverted from
heat flow and \(\Phi\) is estimated.
}\DIFaddend

\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=\textwidth, trim={0 0 0 0}]{figs/Fig4.png}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=\textwidth, trim={0 0 0 0}]{figs/Fig5.png}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=\textwidth, trim={0 0 0 0}]{figs/Fig6.png}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=\textwidth, trim={0 0 0 0}]{figs/Fig7.png}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=0.5\textwidth, trim={0 0 0 0}]{figs/Fig8.png}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=\textwidth, trim={0 0 0 0}]{figs/Fig9.png}
...
\DIFaddbegin \section{\DIFadd{Open Research}}

\DIFadd{All data, scripts, and instructions for compiling, processing, and
visualizing the data in this study can be found at
}\texttt{\DIFadd{https://doi.org/10.17605/OSF.IO/ZJAC3}}\DIFadd{, the official Open
...
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=\textwidth,  trim={0 0 0 0}]{figs/FigS1.png}
...
\end{tabular}
\begin{tablenotes}
\item[\DIFaddFL{1}] $z_c=\phi$,
\item[\DIFaddFL{2}] $z_c=z_{1100}$
\item[\DIFaddFL{3}] $z_c=z_{1100}^2$
\item[\DIFaddFL{4}] $z_c=z_{1100}+z_{1100}^2$
\item[\DIFaddFL{5}] $z_c=z_{1100}+\phi$
\item[\DIFaddFL{6}] $z_c=z_{1100}^2+\phi$
\item[\DIFaddFL{7}] $z_c=z_{1100}+z_{1100}^2+\phi$
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <  \centering
%DIFDELCMD <  \includegraphics[width=0.5\textwidth,  trim={0 0 0 0}]{figs/FigS2.png}
