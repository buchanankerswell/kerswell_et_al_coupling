...
experiments well. Equation~\ref{eq:zc} permits the prediction of the
mechanical coupling depths in modern subduction zones where \(z_{c}\)
...
{\centering \includegraphics[width=0.8\linewidth,]{figs/figA3} 
...
{\centering \includegraphics[width=0.8\linewidth,]{figs/figA4} 
...
{\centering \includegraphics[width=0.8\linewidth,]{figs/figA5} 
