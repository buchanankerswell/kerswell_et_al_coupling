...
% Data filename
filename ='cdf46';
directory = ['/Volumes/My Passport/numerical_models/common_depth_2017_fixed_geotherms/dataset/46km/' filename];
cd(['/Volumes/My Passport/numerical_models/common_depth_2017_fixed_geotherms/dataset/46km/' filename]);
num_name = 240;
num_step = 10;
ext = '.prn';
% Draw isotherms
...
%     set(gca, 'Visible', 'off');
    ...
    set(gcf,'color','w');
    title(['Effective Péclet number | cdf46 | ' num2str(timesum/1e6, '%.2f'),' Ma']);
    export_fig('Fig10a','-png','-r720', '-transparent');
end