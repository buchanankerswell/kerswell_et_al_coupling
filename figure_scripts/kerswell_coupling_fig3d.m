...
for i=1%:1:36
    ...
    set(gcf,'color','w');
    hold on
    [c,h]=contour(gx/1000,gy/1000,(tk-273.15)/300+17,(100:200:2500)/300+17,'Color',[1 1 1],'LineWidth',1);
    colorbar;
    title(['Temperature ^{\circ}C | cdf78 | ', num2str(timesum/1e6, '%.2f'),' Ma']);
    export_fig('Fig3d_cdf78','-png','-r720');
end