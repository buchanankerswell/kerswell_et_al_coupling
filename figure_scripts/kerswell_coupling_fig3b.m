...
% 13 - serpentinized mantle (13) pink  [0.9 0.4 1]
...
%     set(gcf,'Position',[1 1 1280 720]);
    ...
    step2=1;
    colormap(C_map);
    [C,h] = contour(x_vec_t(1:step2:end),z_vec_t(1:step2:end),ColorGrid_t(1:step2:end,1:step2:end),[100:200:1500],'r','LineWidth',1.8);
    ColorGrid(1:40,1)=0:1:39;
    pcolor(x_vec,z_vec,ColorGrid);
    shading flat, caxis ([0 39]), axis ij
    hold on
    [c,h]=contour(x_vec_t(1:step2:end),z_vec_t(1:step2:end),ColorGrid_t(1:step2:end,1:step2:end)/1000,...
        [100:200:2500]/1000,'w','LineWidth',0.5);
    axis ij image
    hold off
    pbaspect([12 1.5 1]);
    ...
    title(['Rock Type | cdf78 | ', num2str(Time/1e6, '%.2f'),' Ma']);
    set(gcf,'color','w');
    filename    =  'Fig3b_cdf78';
    export_fig(filename,'-png','-r720');
end