...
%     set(gcf,'Position',[1 1 1280 720]);
    p = pcolor(gx/1000,gy/1000,log10(nu));
    %caxis([-19 -12]);
    shading interp;
    ...
    set(gcf,'color','w');
    title(['Log Viscosity Pa\cdots | cdf78 | ' num2str(timesum/1e6, '%.2f'),' Ma']);
    export_fig('Fig3e_cdf78','-png','-r720');
end