...
% Data filename
filename ='cdf62';
directory = ['/Volumes/My Passport/numerical_models/common_depth_2017_fixed_geotherms/dataset/62km/' filename];
cd(['/Volumes/My Passport/numerical_models/common_depth_2017_fixed_geotherms/dataset/62km/' filename]);
num_name = 250;
num_step = 10;
ext = '.prn';
% Draw isotherms
...
%     set(gca, 'Visible', 'off');
    ...
    set(gcf,'color','w');
    title(['Effective Péclet number | cdf62 | ' num2str(timesum/1e6, '%.2f'),' Ma']);
    export_fig('Fig10b','-png','-r720', '-transparent');
end